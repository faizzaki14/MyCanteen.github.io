            ...
            <div class="col-lg-12 col-sm-12 col-md-3 row">
              <div class="row">
                <div class="bestdeal mx-auto">
                  <h3 class="fw-bold">Add Canteen</h3>
                  <br /><br />
                  <div class="container">
                    <form method="post" action="functions/add_canteen_process.php">
                      <div class="form-group">
                        <label for="canteen_name">Canteen Name</label>
                        <input type="text" class="form-control" id="canteen_name" name="canteen_name" aria-describedby="canteenHelp" placeholder="Enter Your Canteen Name">
                        <br><br>
                        <label for="canten_name">Canteen Description</label>
                        <textarea class="form-control" id="canten_desc" name="canten_desc" rows="3"></textarea>
                        <br>
