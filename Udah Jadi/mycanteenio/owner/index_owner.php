            ...
            <div class="col-lg-12 col-sm-12 col-md-12 row">
              <div class="row">
                ...
                <?php
                  ...
                  while ($fetchMenu = mysqli_fetch_array($queryMenu)) {
                    if ($fetchMenu['id_canteen'] == $fetch['id']) {
                
                ?>
                <div class="card p-0 mb-4 ml-5" style="width: 20rem; margin-left: 0.8rem;">
                  <img src="../img/<?php  echo $fetchMenu['img_menu'];?>" width="80" height="80">
                  <div class="card-body">
                    ...
                    <div class="formcheck">
                      <form action="">
                        <div class="button-click row pt-3 ps-2">
                          <a href="updateMenu.php?id_c=<?php echo $fetchMenu['id_menu']; ?>" class="btn btn-primary mb-2">Update</a> 
