<?php
  ...
  $queryP = mysqli_query($koneksi, "SELECT * FROM transaction WHERE id_user = '$id_user'");
  $fetchP = mysqli_fetch_array($queryP);
        ...
        <main class="ps-3">
          ...
          <div class="container">
            <div class="col-lg-12 col-sm-12 col-md-12 row">
              <div class="row">
                <div class="card p-0 mb-4 ml-5 mx-auto" style="width: 20rem; height: 100%; margin-left: 0.8rem;">
                  <img src="img/link-aja.png" width="80" height="80">
                  <div class="card-body">
                    <div class="judulmenu d-flex">
                      <div class="col-10 text-start">
                        <h5 class="card-title fw-bold mx-auto">
                            TRANSACTION DETAIL
                        </h5>
                      </div>
                    </div>
                      <h5>Username</h5>
                      <input type="text" name="" value="<?php echo $fetch['username']; ?>" disabled>
                      <br>
                      <h5>Email</h5>
                      <input type="text" name="" value="<?php echo $fetch['email']; ?>" disabled>
                      <br>
                      <h5>Total Amount</h5>
                      <input type="text" name="" value="<?php echo $total; ?>" disabled>
                      <br>
                      <form action="functions/add/add_process.php" method="post">
                        <div class="button-click row pt-3 ps-2">
                          <input type="hidden" name="id_user" value="<?php echo $id_user; ?>">
                          <input type="submit" class="btn btn-danger mb-2" name="submitPay" value="PAY">
                        </div>
                      </form>
                    </div>
                  </div>
